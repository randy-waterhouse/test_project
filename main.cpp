...
{
    {
        ...
        libtorrent::torrent_info("test",ec );
...
int main(int argc, char* argv[])
{
    ...
    try
    {
        ...
        networkSync.subscribeConnectionError([&](const string& error, int) {
            cout << endl << "NetworkSync connection error: " << error << endl;
        });

        networkSync.subscribeProtocolError([&](const string& error, int) {
            cout << endl << "NetworkSync protocol error: " << error << endl;
        });

        networkSync.subscribeBlockTreeError([&](const string& error, int) {
